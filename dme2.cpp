...
/*
 * Changelog:
 * 2014-10-04: Rami Al-Ouran (ra102506@ohio.edu) adds the singlestrand
 *             support
 * 2015-11-04: Liang Chen (Lc726711@ohio.edu) enables the usage message
 *             for singlestrand
 */
...
main(int argc, const char **argv) {
  ...
  try {
	...
	"number of refinement iterations"
      ...
      { "single-strand", '\0',
        POPT_ARG_NONE, &singlestrand, 0, /* @@ lc */
